...
// Replace no-nonsense-nntps, No Nonsense Nntps — See README.adoc for details., just run, No Nonsense Nntps started successfully. with actuals
= no-nonsense-nntps — Quick Start for Users
:toc:
:toclevels: 2

== What is no-nonsense-nntps?

No Nonsense Nntps — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./no-nonsense-nntps-portable
----
...
[source]
----
No Nonsense Nntps started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/no-nonsense-nntps/wiki
