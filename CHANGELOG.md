...
All notable changes to `no-nonsense-nntps` will be documented in this file.
...
- ci: redistribute concurrency-cancel guard to read-only check workflows (#14)
...
- ci: deploy dogfood-gate, add Groove manifest and tests; update CI config
