{
  description = "no-nonsense-nntps - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 no-nonsense-nntps development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P no-nonsense-nntps.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/no-nonsense-nntps $out/bin/  # Rust
            # cp bin/no-nonsense-nntps $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/no-nonsense-nntps";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-no-nonsense-nntps" {
