...
# Justfile for no-nonsense-nntps
...
doctor:
    @echo "Running diagnostics for no-nonsense-nntps..."
...
help-me:
    @echo "=== no-nonsense-nntps Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/no-nonsense-nntps/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: no-nonsense-nntps"
