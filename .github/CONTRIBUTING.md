...
toolbox create no-nonsense-nntps-dev
toolbox enter no-nonsense-nntps-dev
...
no-nonsense-nntps/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
...
### Your First Contribution
    ...
    - [`good first issue`](https://github.com/hyperpolymath/no-nonsense-nntps/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/no-nonsense-nntps/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/no-nonsense-nntps/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/no-nonsense-nntps/labels/perimeter-3) — Community sandbox scope
