...
Replace all {{PLACEHOLDER}} values with your information:
  No Nonsense Nntps     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  no-nonsense-nntps             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/no-nonsense-nntps/security/advisories/new)
...
- This repository (`hyperpolymath/no-nonsense-nntps`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/no-nonsense-nntps/security/advisories)
...
When using No Nonsense Nntps, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/no-nonsense-nntps/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/no-nonsense-nntps/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/no-nonsense-nntps/discussions) |
...
*Thank you for helping keep No Nonsense Nntps and its users safe.* 🛡️
